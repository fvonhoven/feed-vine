...
export function getPlanLimit(
  userPlan: PlanId,
  limit: "maxFeeds" | "maxCategories" | "maxCollections" | "maxWebhooks" | "maxAiSummaries" | "maxStudioGenerations" | "maxTeamMembers",
): number {
