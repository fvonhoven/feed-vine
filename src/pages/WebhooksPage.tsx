    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Webhooks Require Builder Plan</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Upgrade to Builder to use webhooks and integrate FeedVine with Zapier, Make, and other automation tools.
          </p>
